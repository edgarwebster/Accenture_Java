...
class Environment{
    ...
    static String payload="100";
    static String totalweight="30000"; 
    static String listprice="10000";
    static String licenseplatenumber="212345";
    static String annualmileage="10000";
    ...
    static String zipcode="12345678";
    static String city="Curitiba";
    static String occupation="Employee";
    static String hobbie="speeding"; 
    ...
    static String OptionalProducts = "EuroProtection";
    static String courtesycar="Yes";
    
    //Select Price Option
    static String priceOption="platinum";
    
    //Send Quote
    static String email="test@test.com";
    static String phone="123456789";
    static String username="teste";
    static String password="test@Test123";
    static String confirmpassword="test@Test123";
    static String Comments="test"; 
    static String message="Sending e-mail success!";
}